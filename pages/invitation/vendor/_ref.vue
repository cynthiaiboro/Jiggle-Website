      ...
      <div class="row ">
        <div class="col-md-5 mx-auto">
          ...
          <div v-if="invitationAccepted" class="success mt-5">
            ...
            <p class="text-center">
              You have successfully accepted <b>{{ vendor }}'s</b> employee invitation
            </p>
            <p class="text-center">
              Proceed to sign into the jiggle vendor mobile app or download download it from google play store
            </p>
...
<script>
  ...
  export default {
    ...
    mounted() {
      console.log("Invitation component loaded")
      console.log("Invitation Ref: ",this.$route.params.ref)
...
console.log("Error completing employee invite")
            switch (data.message) {
              case 'user_not_found':
                this.showForm()
                break
